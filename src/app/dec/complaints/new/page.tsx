...
export default function DecNewComplaintPage() {
    ...
    <div className="max-w-xl mx-auto p-4 sm:p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-black/5 p-6 space-y-4">
        <div>
          ...
          <input value={subject} onChange={(e) => setSubject(e.target.value)} required placeholder="Brief subject"
        ...
        <div>
          ...
          <textarea value={description} onChange={(e) => setDescription(e.target.value)} required rows={5} placeholder="Describe in detail"
        ...
        <div className="flex gap-3 pt-2">
          <button type="button" onClick={() => router.back()} className="flex-1 border border-black/15 text-[#180F04] py-2 rounded-lg text-sm hover:bg-black/5 transition-colors">Cancel</button>
