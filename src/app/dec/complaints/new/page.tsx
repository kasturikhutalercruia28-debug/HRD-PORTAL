    ...
    <div className="max-w-xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-black/5 p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <button type="button" onClick={() => router.back()} className="flex-1 border border-black/15 text-[#0D0D0B] py-2 rounded-lg text-sm hover:bg-black/5 transition-colors">Cancel</button>
