...
export default function DrrComplaintDetailPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <Link href="/drr/complaints" className="inline-flex items-center gap-1.5 text-sm text-[#0D0D0B]/50 hover:text-[#0D0D0B] mb-4 transition-colors">
      ...
      <div className="bg-white rounded-xl border border-black/5 p-6 mb-4">
        ...
        <p className="text-xs text-[#0D0D0B]/50 mb-3">{complaint.submitter.name} · {complaint.submitter.role} · {new Date(complaint.createdAt).toLocaleString("en-IN")}</p>
